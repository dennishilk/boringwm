...
ok test "${packages[*]}" = 'build-essential cargo clippy dbus-x11 dunst feh firefox-esr fonts-dejavu fonts-liberation gvfs kitty libxcb1-dev lightdm lightdm-gtk-greeter picom pkg-config polkitd rofi rustc rustfmt thunar x11-xserver-utils xinit xorg'
